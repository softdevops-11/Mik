...
namespace Shapes
{
    ...
    {
        public static IShape SortingShapesArea(IShape[] shapes)
        {
        ...
        public static IShape SortingShapesPerimeter(IShape[] shapes)
        {
        ...
        private static void Main()
        {
            ...
            IShape maxAreaShape = SortingShapesArea(shapes);
            IShape secondPerimeterShape = SortingShapesPerimeter(shapes);
